...
class Make_Scan(object):
    ...
    def __init__(self, compare_7d=False,
        ...
        self.master['axi_o0'] = self.fig.add_axes([xloc, 0.788, dx, dy])
        self.master['axi_o1'] = self.fig.add_axes([xloc, 0.662, dx, dy])
        self.master['axi_o2'] = self.fig.add_axes([xloc, 0.536, dx, dy])
        self.master['axi_o3'] = self.fig.add_axes([xloc, 0.408, dx, dy])
        self.master['axi_o4'] = self.fig.add_axes([xloc, 0.282, dx, dy])
    ...
    def set_fig_frame(self):
        ...
        self.master['ax_0'].set_ylim(0.01, 10.)      
