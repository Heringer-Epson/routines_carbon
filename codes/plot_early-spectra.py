...
class Plot_L_Fe(object):
    ...
    def __init__(self, lm='downbranch', L_range=None, Fes_range=None,
        ...
        self.L_scal = np.arange(0.6, 2.01, 0.1)
        self.L = np.array([lum2loglum(0.32e9 * l) for l in self.L_scal]) 
        self.Fes = np.array(['0.00', '0.05', '0.10', '0.20', '0.50',
    ...
    def load_data(self):
        ...
        case_folder = path_tardis_output + 'early-carbon-grid_new/'
    ...
    def add_title_and_legend(self):
        title = r'11fe_early' + self.title_suffix
    ...
    def save_figure(self):        
        if self.save_fig:
            ...
            plt.savefig(directory + 'Fig_early-spectra' + self.name_suffix
                        + '_' + self.lm + '_new.png', format='png', dpi=360)
...
Plot_L_Fe(lm='macroatom', L_range=None, Fes_range=None, T_range=None, 
          colormap_for='L', show_fig=True, save_fig=True)
